...
//!
//! This crate provides traits for serializing and deserializing data structures according to the
...
//!
//! Additionally, this crate also provides implementations of these traits for all basic types and
